...
from ai_extraction import extract_full_pipeline
from deduplication import deduplicate_entities, remap_relationships
from graph_builder import build_graph_data
from audit_log import log_action
from graph_state import load_graph, save_graph, push_undo, require_project, get_pipeline_status
...
async def upload_documents(
    ...
    if not files_data:
        return JSONResponse(
            {"success": False, "error": "No processable files", "errors": all_errors},
            status_code=400,
        )
    ...
    try:
        ...
        return JSONResponse(
            {"success": False, "error": str(e), "errors": all_errors},
            status_code=500,
        )
    finally:
        ps["running"] = False
